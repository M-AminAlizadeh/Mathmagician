<h3><b>Mathmagician Project</b></h3>
# 📗 Table of Contents
...
```sh
  git clone https://github.com/M-AminAlizadeh/Mathmagician.git
```
...
Feel free to check the [issues page](https://github.com/M-AminAlizadeh/Mathmagician/issues).
